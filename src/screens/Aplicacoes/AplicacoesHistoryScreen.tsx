    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.scrollContent}>
      <View style={styles.topButtonContainer}>
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('AplicacaoForm', { plantioId, estufaId })}
        >
          ...
          <View key={item.id} style={styles.itemCard}>
            <View style={styles.itemHeader}>
              <View style={styles.dateInfo}>
                ...
                <Text style={styles.itemDate}>{formatDateSafe(item.dataAplicacao)}</Text>
              </View>

              <TouchableOpacity onPress={() => handleClonarAplicacao(item)} style={styles.cloneButton}>
...
const styles = StyleSheet.create({
  ...
  itemCard: {
    ...
    borderRadius: 12,
    borderLeftWidth: 5,
    borderLeftColor: COLORS.cFF9800,
