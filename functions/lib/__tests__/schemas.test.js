...
describe('Validação de Schemas (Zod)', () => {
    describe('VendaSchema', () => {
        it('deve aceitar uma venda válida', () => {
            ...
            const result = schemas_1.VendaSchema.safeParse(validVenda);
        ...
        it('deve rejeitar venda com valor negativo', () => {
            ...
            const result = schemas_1.VendaSchema.safeParse(invalidVenda);
    ...
    describe('DespesaSchema', () => {
        it('deve aceitar uma despesa válida', () => {
            ...
            const result = schemas_1.DespesaSchema.safeParse(validDespesa);
            expect(result.success).toBe(true);
        });
        it('deve rejeitar despesa com valor zero ou menor', () => {
            ...
            const result = schemas_1.DespesaSchema.safeParse(invalidDespesa);
            expect(result.success).toBe(false);
        });
    });
});
