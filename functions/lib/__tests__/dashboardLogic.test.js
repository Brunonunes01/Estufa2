...
describe('Lógica de Cálculo do Dashboard', () => {
    it('deve somar corretamente vendas pagas e pendentes', () => {
        ...
        const result = (0, dashboardSummary_1.calculateFinancials)(mockVendas, mockDespesas);
        expect(result.totalRecebido).toBe(130);
...
//# sourceMappingURL=dashboardLogic.test.js.map